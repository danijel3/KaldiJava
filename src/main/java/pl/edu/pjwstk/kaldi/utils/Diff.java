...
public class Diff {
     ...
     * accordingly.
     *
     * @param hyp hypothesis returned by the decoder (2 tiers: words and
     *            phonemes)
     * @param ref reference known to be true
    ...
    public static Segmentation diff(Segmentation hyp, String ref, double file_len) {
        ...
        LinkedList<String> hyp_words = new LinkedList<>();
        LinkedList<String> ref_words = new LinkedList<>();
        Vector<String> ref_vec = new Vector<>();
     ...
     *
     * @param hyp    hypothesis returned by the decoder (single tier)
     * @param ref    reference known to be true
     * @param strict if false, allow expanding word context
